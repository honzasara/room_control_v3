...
#define NEW_MENU_VIRTUAL_OUTPUT_CONFIG 20
...
#define MENU_SLIDER_KNOW_VIRTUAL_OUTPUT 5
#define MENU_SLIDER_LIST_VIRTUAL_OUTPUT 6
#define MENU_SLIDER_LIST_ALL_PROGRAM 7
#define MENU_SLIDER_LIST_PROGRAM_INTERVAL 8
